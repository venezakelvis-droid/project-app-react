...
const StudentReportCardPage = () => {
    const { grades, loading, error, fetchStudentGrades } = useGrades({ fetchOnMount: false });
    ...
    return (
        <div className="space-y-6">
            <h1 className="text-3xl font-bold text-foreground">Boletim</h1>
                        ...
                        <div key={idx} className="rounded-lg border border-border bg-card p-6">
                            ...
                            <div className="mb-6 flex items-center justify-between">
                                <h2 className="text-xl font-semibold text-foreground">
                                    Disciplina {grade.enrollmentId || idx + 1}
                                </h2>
