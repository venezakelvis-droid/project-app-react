  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80 hover:shadow-cyan",
        ghost: "hover:bg-muted hover:text-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        hero: "bg-gradient-primary text-primary-foreground font-semibold shadow-glow hover:scale-[1.03] hover:shadow-[0_0_60px_hsl(var(--primary)/0.7)]",
        cyan: "bg-gradient-cyan text-secondary-foreground font-semibold hover:scale-[1.03] hover:shadow-cyan",
        glass: "glass text-foreground hover:bg-card/80 hover:border-primary/40",
      },
      size: {
        default: "min-h-[44px] h-11 px-5 py-2",
        sm: "min-h-[40px] h-10 rounded-full px-4 text-sm",
        lg: "min-h-[48px] h-12 rounded-full px-8 text-base",
        xl: "min-h-[56px] h-14 rounded-full px-10 text-base",
